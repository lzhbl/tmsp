...
<div id="updateDialog" class="crudDialog">
	<form id="updateForm" method="post">
		<div class="form-group">
			...
			<input id="name" type="text" class="form-control" name="name" maxlength="20" value="${user.name}"  >
		</div>
		<div class="form-group">
			<label for="location">景点位置</label>
			<input id="location" type="text" class="form-control" name="location" maxlength="20" value="${user.location}">
		</div>
		<div class="row">
			<div class="col-lg-8 form-group">
				<label for="pictures">图片</label>
				<input id="pictures" type="text" class="form-control" name="pictures" maxlength="150" value="${user.pictures}">
			</div>
			<div class="col-lg-4">
		...
		<div class="form-group">
			...
			<input id="price" type="text" class="form-control" name="price" maxlength="20" value="${user.price}">
		</div>
		<div class="form-group">
			<label for="devtime">开发时间</label>
			<input id="devtime" type="text" class="form-control" name="devtime" maxlength="50" value="${user.devtime}">
		</div>
		<div class="form-group">
			<label for="introduce">景点介绍</label>
			<input id="introduce" type="text" class="form-control" name="introduce"  maxlength="50" value="${user.introduce}"/>
		</div>
		<div class="radio">
			<div class="radio radio-inline radio-info">
				<input id="sex_1" type="radio" name="category" value="1" <c:if test="${user.category==1}">checked</c:if>>
				<label for="sex_1">自然风光 </label>
			</div>
			<div class="radio radio-inline radio-danger">
				<input id="sex_0" type="radio" name="category" value="0" <c:if test="${user.category==0}">checked</c:if>>
