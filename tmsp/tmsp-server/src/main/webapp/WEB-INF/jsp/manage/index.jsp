	...
	<ul id="menu">
		...
		<li class="pull-right">
			<ul class="hi-menu">
				...
				<li class="dropdown">
					<a class="waves-effect waves-light"  title="门户网站" href="../html/index.html">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dm-icon pull-right">
						...
						<%--<li class="hidden-xs">--%>
							<%--&lt;%&ndash;href="${basePath}/tourism/index"&ndash;%&gt;--%>
							<%--<a class="waves-effect" data-ma-action="clear-localstorage" href="../html/index.html"><i class="zmdi zmdi-fullscreen"></i> 门户网站</a>--%>
						<%--</li>--%>
						<li>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
                <%--<img src="${basePath}/resources/image/leader.jpg " />--%>
...
<script type="text/javascript" color="0,0,255" opacity='0.7' zIndex="-2" count="99" src="${basePath}/resources/zheng-admin/js/canvas-nest.min.js"></script>
</body>
</html>